...
const AdminSalesRequest = () => {
  ...
  const salesRequests = [
    { id: 1, category: '상품 A', title: '판매신청 A', nickname: '홍길동', date: '2024-11-01', content: '판매신청 A의 상세 내용입니다.' },
    { id: 2, category: '상품 B', title: '판매신청 B', nickname: '김철수', date: '2024-11-02', content: '판매신청 B의 상세 내용입니다.' },
    { id: 3, category: '상품 C', title: '판매신청 C', nickname: '이영희', date: '2024-11-03', content: '판매신청 C의 상세 내용입니다.' },
    { id: 4, category: '상품 D', title: '판매신청 D', nickname: '박민수', date: '2024-11-04', content: '판매신청 D의 상세 내용입니다.' },
  ];
