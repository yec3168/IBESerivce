    ...
    return (
      <>
          <Navbar expand="lg" className="flex-column" id="mypage_sidenav">
            <Navbar.Brand href="/mypage" id="mypage_sidenav_mypage" className="me-auto my-1" style={{ marginLeft:'10px'}}>
              마이페이지
            </Navbar.Brand>
            <Nav className="flex-column me-auto" style={{ marginLeft:'40px', marginTop:'10px' }}>
              <Nav.Link className='disabled' id="mypage_sidenav_bigmenu">아이비 히스토리</Nav.Link>
                <div className="ml-5 mb-2" id="mypage_sidenav_smenu" style={{ marginLeft:'30px'}}>
