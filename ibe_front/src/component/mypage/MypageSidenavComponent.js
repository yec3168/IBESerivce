      ...
      <>
        {/* <div id="div_headerHeight" /> */}
          <Navbar expand="lg" className="flex-column" id="mypage_sidenav">
            <Navbar.Brand href="#" className="me-auto my-1" style={{ marginLeft:'10px'}}>
              마이페이지
            </Navbar.Brand>
            <Nav className="flex-column me-auto" style={{ marginLeft:'30px', marginTop:'10px' }}>
              <Nav.Link href="#" id="mypage_sidenav_bigmenu">마이 아이비</Nav.Link>
                <div className="ml-5" id="mypage_sidenav_smenu" style={{ marginLeft:'20px'}}>
                  <Nav.Link href="#">구매 내역 조회</Nav.Link>
                  <Nav.Link href="#">판매 내역 조회</Nav.Link>
                </div>
